...
private int i=0;
	...
	private void initialize() {
		...
		btnNewButton_3 = new JButton("anulerer");
		btnNewButton_3.setBounds(186, 554, 85, 21);
		frame.getContentPane().add(btnNewButton_3);
		
		btnNewButton_4 = new JButton("retour");
		btnNewButton_4.setBounds(188, 605, 85, 21);
